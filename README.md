...
{
  "recipeScores": {"1": 0.4},
  "ingredientPreference": {"豚バラ肉": 0.3},
  "moodHistory": ["疲れた", "がっつり"],
  "categoryStats": {"疲れた": 5}
}
```
...
### レシピ追加
`data/recipes.json` にレシピオブジェクトを追加
...
- 🐛 バグ報告: [Issues](https://github.com/username/kondate-app/issues)
- 💡 機能要望: [Discussions](https://github.com/username/kondate-app/discussions)
- 📧 お問い合わせ: contact@kondate-app.com
